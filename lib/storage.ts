...
// Prioritize standard SUPABASE env vars, fallback to VITE_ prefixed ones
...
export class SupabaseStorage implements IStorage {
    private getSupabase() {
        if (!supabase) {
            throw new Error("Supabase client not initialized. Check your environment variables (SUPABASE_URL/ANON_KEY).");
        }
        return supabase;
    }
